...
$(window).on('load resize', function(){
  ...
  if (window.matchMedia("(min-width: 767px)").matches) { 
      ...
      var alignedButtons = document.querySelectorAll('.align-buttons-here');
      var tallestButtonParent;
      var tallestHeight = 0;
      ...
      for (var i = 0; i < alignedButtons.length; i++) {
          ...
          var difference = tallestHeight - itemHeight;
							console.log("Div number " + alignedButtons[i])
              ...
              alignedButtons[i].querySelector('.align-buttons-here a').style.marginTop = difference + "px";
        			console.log(itemHeight + difference);
        itemHeight = alignedButtons[i].offsetHeight;
              console.log(itemHeight);
//           }
      }
